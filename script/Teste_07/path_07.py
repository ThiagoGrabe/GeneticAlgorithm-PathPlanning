...
def individual (nPoints, start, goal, p2, p3, p4, map_size):
    ...
    p5 = (int(np.random.random()*map_size), int(np.random.random()*map_size))
    p6 = (int(np.random.random()*map_size), int(np.random.random()*map_size))
    p7 = (int(np.random.random()*map_size), int(np.random.random()*map_size))
    p8 = (int(np.random.random()*map_size), int(np.random.random()*map_size))
...
def inside_circle_01(x, y, a=7.3, b=7.3, r=4.5):
...
def getCurve(image_dir="", image_name="path"):
    ...
    xs = [x[0] for x in best_individual]
    ys = [x[1] for x in best_individual]
    circle_01=plt.Circle((7.3,7.3), 4.2,color='black')
